...
public class SwaggerConfig {
    ...
    public Docket productApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("pl.matiej.jdd.controller"))
    ...
    private ApiInfo metaInfo() {
        return new ApiInfoBuilder().title("JDD")
                .description("Junior developer diary. ")
                .version("0.1")
                .contact(new Contact("Matiej", "www.nourl.pl", "maciek@testaarosa.pl"))
